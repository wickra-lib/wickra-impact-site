...
- GitHub → the [wickra-impact repository](https://github.com/wickra-lib/wickra-impact)
...
Wickra Impact parses untrusted `ScanSpec` JSON and candle data, so its parser and
...
[SECURITY.md](https://github.com/wickra-lib/wickra-impact/blob/main/SECURITY.md)
